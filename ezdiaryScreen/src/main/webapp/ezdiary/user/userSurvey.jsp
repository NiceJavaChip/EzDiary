   ...
   <div class="usermain_wrapper survey">
      <div class="content_wrapper" id="divBox">
         ...
         <div class="select_items">
            <button class="items_btn" id="start_btn1" type="button">코딩과 1도 관련 없는 비전공자 취준생</button>
            <button class="items_btn" id="start_btn1" type="button">4년을 무사히 졸업한 컴광과 취준생</button>
            <button class="items_btn" id="start_btn1" type="button">직무 전환을 위해 고민하는 재직자</button>
      ...
      <div class="content_wrapper2" id="divBox2">
         <div class="upper_title">
            <p>취업이 안 되는 코로나 시기... 
            아이러니 하게도 이 시기에 코딩 열풍이다
            현재 내 상태는?</p>
         ...
         <div class="select_items">
            <button class="items_btn" id="start_btn2" type="button">제발 한번에 되게 해주세요</button>
            <button class="items_btn" id="start_btn2" type="button">제발 한번에 되게 해주세요</button>
            <button class="items_btn" id="start_btn2" type="button">제발 한번에 되게 해주세요</button>
            <button class="items_btn" type="button" onclick="location.href='userResultloading.jsp'">더 나은 곳으로 이직을 위해 고민하는 재직자</button>
         </div>
      ...
      <div class="content_wrapper2" id="divBox3">
         <div class="upper_title">
            <p>취업이 안 되는 코로나 시기... 
            아이러니 하게도 이 시기에 코딩 열풍이다
            현재 내 상태는?</p>
         ...
         <div class="select_items">
            <button class="items_btn" id="start_btn3" type="button">이렇게 하면 되는건가...</button>
            <button class="items_btn" id="start_btn3" type="button">이렇게 하면 되는건가...</button>
            <button class="items_btn" id="start_btn3" type="button">이렇게 하면 되는건가...</button>
            <button class="items_btn" type="button" onclick="location.href='userResultloading.jsp'">더 나은 곳으로 이직을 위해 고민하는 재직자</button>
         </div>
