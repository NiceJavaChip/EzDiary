	...
	<div class="usermain_wrapper">
		<div class="content_wrapper" id="divBox">
			...
			<div class="select_items">
				<button class="items_btn" id="fadeOutBtn" type="button">코딩과 1도 관련 없는 비전공자 취준생</button>
				<button class="items_btn" id="fadeInBtn" type="button">4년을 무사히 졸업한 컴광과 취준생</button>
